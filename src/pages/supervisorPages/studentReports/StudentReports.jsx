...
function StudentReports() {
  ...
  console.log("useGetAllOfMyStudentsCases:",data);
   ...
   const reviewedCount = data?.items?.filter(report => report.isReviewed)?.length || 0; // لعرض عدد الريفيود 
...
if (feedbackFilter !== "all") {
  ...
  return (
    ...
    <DashboardNavbar />
          ...
          {totalReports > 0 && (
            <>
               <Box sx={{display:'flex',justifyContent: "space-between",marginBottom:'30px',alignItems:'center',marginTop:'10px',
             "@media (max-width:1044px)": {
              ...
              <Box className="numbers" sx={{display:'flex',gap:'10px',"@media (max-width:1044px)": {
                  marginTop:'20px',
                }}}>
                <Box className='total_reports' sx={{border: "1px solid #57565662",borderRadius: "15px",bgcolor:'#181b21',padding:'15px', height:{sm:'100px',md:'fit-content'},width:{xs:'50%',md:'fit-content'}}}>
                  <Box sx={{display:'flex',alignItems:'center',gap:'10px',}}>
                      <FaFileAlt size={17} color='#fa0202'/>
                  <Typography sx={{color:'#7e8a9a',fontFamily: "var(--primary-font)", overflowWrap: "break-word","@media (max-width:418px)": {
                 fontSize:'13px'
                },}}>Total Reports</Typography>
                 </Box>
                   <Typography sx={{color:'#fff',fontWeight:'600',fontSize:'20px'}}>{totalReports}</Typography>
                </Box>
                <Box className='reviewed_reports' sx={{border: "1px solid #57565662",borderRadius: "15px",bgcolor:'#181b21',padding:'15px',  height:{sm:'100px',md:'fit-content'},width:{xs:'50%',md:'fit-content'}}}>
                  <Box sx={{display:'flex',alignItems:'center',gap:'10px',paddingX:'9px', flexShrink: 0}}>
                      <FaArrowTrendUp size={20} color='#02fa13'/>
                  <Typography sx={{color:'#7e8a9a',fontFamily: "var(--primary-font)", overflowWrap: "break-word","@media (max-width:418px)": {
                 fontSize:'12px'
                },}}>Total Reviewed </Typography>
                 </Box>
                   <Typography sx={{color:'#fff',fontWeight:'600',fontSize:'20px',paddingLeft:'8px'}}>{reviewedCount}</Typography>
                </Box> 
              </Box>
               </Box>
                 ...
                 <Grid item size={{xs:12,sm:6,lg:4}}>
                      <Box className="report" sx={{bgcolor:'#15181e',padding:'25px',border: "1px solid #ff01013b",borderRadius: "15px",}}>
                        <Box className='report_details'>
                          <Typography sx={{color:'#fff',fontWeight:'500',fontSize:'15px',marginBottom:'10px',fontFamily: "var(--primary-font)",}}>{report.reportNumber}</Typography>
