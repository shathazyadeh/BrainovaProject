    ...
    <Box>
      ...
      <Modal open={open} onClose={() => setOpen(false)} slotProps={{
        ...
        >
          ...
          <Typography sx={{ color: "var(--secondary-color)", fontSize: { xs: "13px", sm: "17px" }, maxHeight: "100px",
    overflowY: "auto",
    whiteSpace: "pre-wrap",
...
function MyCases() {
 ...
 const filteredData = data?.items?.filter((item) => {   //للفلترة
  ...
  return (
    <Box className='section' sx={{  bgcolor: 'var(--navy-color)', paddingTop: { md: '40px', xs: '20px' }, flex: 1, minHeight: '100vh', }}>
      <Container maxWidth='lg'>
        ...
        <Box className={style.section_titel} sx={{ marginBottom: '40px', paddingX: '50px', paddingY: '80px', display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: "center", textAlign: 'center', boxShadow: "0 0 30px rgba(207, 25, 25, 0.2)", }}>
          <Box >
            ...
            <Typography sx={{fontSize:{xs:'15px',sm:'16px',md:'18px'}, color: 'var(--secondary-color)', paddingLeft: '15px', paddingBottom: '10px', marginTop: '10px', letterSpacing: '2px', fontWeight: '500' }}>Track your submitted analyses, predictions, and supervisor feedback</Typography>
          </Box>
          <Box sx={{ display: "flex", gap: "20px", marginBottom: "15px" }}>
            <Box sx={{ display: 'flex',  "@media (max-width:544px)": {
      flexWrap: 'wrap',
      gap:'10px'
    }, gap: '20px',justifyContent:'center', borderTop: '1px solid #55555585', paddingTop: '20px' }}>
              ...
              fontSize:{xs:'15px',sm:'16px',md:'18px'},
               ...
               <Typography sx={{
                whiteSpace: 'nowrap',fontSize:{xs:'15px',sm:'16px',md:'18px'}, bgcolor: "#66656549", color: "#e0c13a", border: '1px solid #777575a8', fontWeight: '500', paddingX: '15px', paddingY: '5px', borderRadius: '10px', boxShadow: "0 0 15px rgba(65, 63, 63, 0.46)", "&:hover": {
                  color: '#fff',
                  bgcolor: "#e0c13a"
                },
              ...
              <Typography sx={{
                whiteSpace: 'nowrap',fontSize:{xs:'15px',sm:'16px',md:'18px'}, bgcolor: "#66656549", color: "#24b362", border: '1px solid #777575a8', fontWeight: '500', paddingX: '15px', paddingY: '5px', borderRadius: '10px', boxShadow: "0 0 15px rgba(65, 63, 63, 0.46)", "&:hover": {
                  color: '#fff',
                  bgcolor: "#24b362",
                },
 ...
 alignSelf: 'center',
  ...
  >
    ...
    <Box ><TbReportSearch size={180}  color= {'var(--secondary-color)'}/></Box>

   
    <Typography sx={{ fontSize: {xs:'25px',md:'30px'},  color: "var(--primary-color)",fontWeight: "600",fontFamily:'var(--primary-font)' }}>
      No cases found
    </Typography>

   
    <Typography sx={{fontSize: {xs:'20px',md:'20px'}, color: "var(--secondary-color)", opacity: 0.7 ,fontFamily:'var(--primary-font)'}}>
          ...
          paginatedData?.map((item ) => (
            ...
            <Grid item size={{lg:6 , xs:12,sm:6}} key={item.caseId}>
              <Box  className='student_case flex_column' sx={{bgcolor:'#1f1f1f',borderRadius:'15px',padding:'10px',border:'1px solid #525252a8',gap:'5px', transition:'all 0.4s', "&:hover": {
                ...
                <Box className='img_container' sx={{ width: 80, height: 70, flexShrink: 0  ,"@media (max-width:1023px)": {
...
<Box className='left_side flex_column ' sx={{gap:'5px' , "@media (min-width:1024px)": {
 ...
 <Typography
                   ...
                   <Typography sx={{color:"var(--secondary-color)",fontSize:'12px',fontWeight:'500',paddingRight:"18px","@media (max-width:1023px)": {   
                                                 marginLeft:'5px'
              ...
              <Box className='feedback flex_column' sx={{gap:'5px',  "@media (max-width:1023px)": {  borderTop:'1px solid #4f4f4f75', padding:'4px' ,
                                                 marginLeft:'10px',
                                             }}}>
                  <Box sx={{display:'flex' ,alignItems:'center',"@media (max-width:1023px)": {gap:'5px',paddingTop:'4px',  }}}>
                    <LuNotebookPen color='#c21313'/>
                    <Typography sx={{color:'#fff', "@media (min-width:1024px)": {   
                                                 marginLeft:'5px',
                                             }}}>Feedback</Typography>
                  </Box>
                ...
                <Box className='pdf flex_column' sx={{  marginLeft: '15px' ,justifyContent:'center',gap:"10px",marginTop:'5px',"@media (max-width:1023px)": {   
