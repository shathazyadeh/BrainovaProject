...
function MyCases() {
  ...
  return (
    <Box className='section' sx={{
      bgcolor: 'var(--navy-color)', paddingTop: { md: '40px', xs: '20px' }, flex: 1,
      ...
      <Container maxWidth='lg'>
        ...
        <Box className={style.section_titel} sx={{ marginBottom: '40px', paddingX: '50px', paddingY: '80px', display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: "center", textAlign: 'center', boxShadow: "0 0 30px rgba(207, 25, 25, 0.2)", }}>
          <Box >
            <Typography
              component={"h1"}
              variant="h4"
            ...
            <Typography sx={{ fontSize: { xs: '10px', sm: '16px', md: '18px' }, color: 'var(--secondary-color)', paddingLeft: '15px', paddingBottom: '10px', marginTop: '10px', letterSpacing: '2px', fontWeight: '500' }}>Track your submitted analyses, predictions, and supervisor feedback</Typography>
          </Box>
          <Box sx={{ display: "flex", gap: "20px", marginBottom: "15px" }}>
            <Box sx={{
              display: 'flex', gap: '20px', justifyContent: 'center', borderTop: '1px solid #55555585', paddingTop: '20px'
              ...
              <Typography sx={{
                whiteSpace: 'nowrap', bgcolor: "#66656549", color: "#fa0000", border: '1px solid #777575a8', fontWeight: '500', paddingX: '15px', paddingY: '5px', borderRadius: '10px', boxShadow: "0 0 15px rgba(65, 63, 63, 0.46)",
                fontSize: { xs: '13px', sm: '16px', md: '18px' }, transition: "0.3s all",
                "&:hover": {
                  color: '#fff',
                  bgcolor: "#fa0000"
                }
              ...
              <Typography sx={{
                whiteSpace: 'nowrap', fontSize: { xs: '13px', sm: '16px', md: '18px' }, bgcolor: "#66656549", color: "#e0c13a", border: '1px solid #777575a8', fontWeight: '500', paddingX: '15px', paddingY: '5px', borderRadius: '10px', boxShadow: "0 0 15px rgba(65, 63, 63, 0.46)", transition: "0.3s all", "&:hover": {
                  color: '#fff',
                  bgcolor: "#e0c13a"
                },
              ...
              <Typography sx={{
                whiteSpace: 'nowrap', fontSize: { xs: '13px', sm: '16px', md: '18px' }, bgcolor: "#66656549", color: "#24b362", border: '1px solid #777575a8', fontWeight: '500', paddingX: '15px', paddingY: '5px', borderRadius: '10px', boxShadow: "0 0 15px rgba(65, 63, 63, 0.46)", transition: "0.3s all", "&:hover": {
                  color: '#fff',
                  bgcolor: "#24b362",
                },
                "@media (max-width:544px)": {
        ...
        <Box className='filter' sx={{ display: "flex", gap: "10px", marginBottom: "20px", alignItems: 'center' }}>
          <FiFilter size={20} style={{ flexShrink: 0 }} color='var(--secondary-color)' />
          ...
          {(!paginatedData || paginatedData.length === 0) ? (
            <Box sx={{ width: '100%', display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              >
                ...
                <Box ><TbReportSearch size={110} color={'var(--secondary-color)'} /></Box>


                <Typography sx={{ fontSize: { xs: '22px', md: '30px' }, color: "var(--primary-color)", fontWeight: "600", fontFamily: 'var(--primary-font)' }}>
                  No cases found
                </Typography>


                <Typography sx={{ fontSize: { xs: '15px', md: '20px' }, color: "var(--secondary-color)", opacity: 0.7, fontFamily: 'var(--primary-font)' }}>
            ...
            paginatedData?.map((item) => (
              ...
              <Grid item size={{ lg: 6, xs: 12, sm: 6 }} key={item.caseId}>
                <Box className='student_case flex_column' sx={{
                  bgcolor: '#1f1f1f', borderRadius: '15px', padding: '10px', border: '1px solid #525252a8', gap: '5px', transition: 'all 0.4s', "&:hover": {
                  ...
                  <Box className='img_container' sx={{
                    width: 80, height: 70, flexShrink: 0, "@media (max-width:1023px)": {
                  ...
                  <Box className='card_details' sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Box className='left_side flex_column ' sx={{
                      gap: '5px', "@media (min-width:1024px)": {
                        alignItems: 'flex-start',
                      },
                    }}>
                      <Typography sx={{ marginLeft: '14px', color: '#ffffff', fontSize: '13px', fontWeight: '500', "@media (min-width:1024px)": { display: 'none' } }}>{item.reportCode}</Typography>
                      <Typography sx={{ marginLeft: '14px', color: "var(--secondary-color)", fontSize: '13px', fontWeight: '500', "@media (min-width:1024px)": { display: 'none' } }}>Prediction</Typography>
                      <Typography sx={{ marginLeft: '14px', color: "var(--secondary-color)", fontSize: '13px', fontWeight: '500', "@media (min-width:1024px)": { display: 'none' } }}>Submitted</Typography>

                    </Box>
                    <Box className='right_side flex_column ' sx={{ gap: '5PX' }}>
                      <Typography sx={{ color: '#ffffff', fontSize: '14px', fontWeight: '500', whiteSpace: "nowrap", "@media (max-width:1023px)": { display: 'none' } }}>{item.reportCode}</Typography>
                      ...
                      <Typography sx={{
                        color: "var(--secondary-color)", fontSize: '12px', fontWeight: '500', paddingRight: "18px", "@media (max-width:1023px)": {
                          marginLeft: '5px'
                        }
                      }}>{item.reportSubmittedAt.split("T")[0]}</Typography>
                  ...
                  <Box className='feedback flex_column' sx={{
                    gap: '5px', "@media (max-width:1023px)": {
                      borderTop: '1px solid #4f4f4f75', padding: '4px',
                      marginLeft: '10px',
                    }
                  }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', "@media (max-width:1023px)": { gap: '5px', paddingTop: '4px', } }}>
                  ...
                  <Box className='pdf flex_column' sx={{
                    marginLeft: '15px', justifyContent: 'center', gap: "10px", marginTop: '5px', "@media (max-width:1023px)": {
                      width: '100%', marginLeft: '0px', flexDirection: 'row'
                    }
                  }}>
                    <Button
        ...
        <Box className="pagination" sx={{ display: "flex", justifyContent: "center", marginTop: "30px", padding: "20px", paddingBottom: "80px" }}>
          <Pagination
