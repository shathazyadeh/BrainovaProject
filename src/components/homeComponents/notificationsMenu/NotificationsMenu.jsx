      ...
      >
        <Box className="notification_header">
          <Grid container spacing={5}>
            <Grid item size={{ xs: 6 }} sx={{display:"flex",paddingLeft:"10px",gap:"10px"}}>
              <Typography onClick={closeUnreedList}
                sx={{
              ...
              <Typography onClick={openUnreedList}
                sx={{
                  fontFamily: "var(--primary-font)",
                  fontWeight: "600",
                  fontSize: "11px",
        ...
        {openUnseenOnly ? 
        unseenFeedbacksData?.items.map((feedback) => {
          const isSeen =
          ...
          return (
            ...
            >
              ...
              <Box className="content flex_column">
                ...
                <Typography
                  sx={{ fontSize: "10px", color: "var(--secondary-color)",fontWeight:"300" }}
                >
